...
/*************************************************************************//*!
*
*   @brief Removes all whitespace in a string.
*
*   @param begin the starting iterator of the string to condense.
*
*   @param end the end iterator of the string to condense.
*
...
*
*   @param begin the starting iterator of the string to strip.
*
*   @param end the end iterator of the string to strip.
*
...
/*************************************************************************//*!
*
*   @brief Splits a sequence, at any whitespace, into an std::vector.
*
*   @param begin the starting iterator of the sequence to split.
*
*   @param end the end iterator of the sequence to split.
*
*   @return std::vector with the split elements of the string
*
****************************************************************************/
...
/*************************************************************************//*!
*
*   @brief Joins a sequence into a string, with str delimiting the entries.
*
*   @param begin the starting iterator of the sequence to join.
*
*   @param end the end iterator of the sequence to join.
*
*   @param str the delemiting string between the entries of the sequence.
*
*   @return the joined string
*
****************************************************************************/

std::string join(vec_cItr begin, vec_cItr end, const std::string& str = std::string());


/*************************************************************************//*!
*
*   @brief Splits first word from any string and returns it
*
*   @see   split()
*
*   @return The first white-space delimited element of the sequence
*
****************************************************************************/
...
/*************************************************************************//*!
*
*   @brief An XMLNode is a single node in an XML document.
*
*   @details The XMLNode class provides methods and interfaces to traverse
...
public:
    ...
    *
    *   @return Returns an XMLNode* if the parent exists, else returns NULL.
    *
    ****************************************************************************/
    ...
    *
    *   @return Returns an XMLNode* if the previous sibling exists, else returns NULL.
    *
    ****************************************************************************/
    ...
    *
    *   @return Returns an XMLNode* if the next sibling exists, else returns NULL.
    *
    ****************************************************************************/
    ...
    *
    *   @return Returns an XMLNode* if a first child exists, else returns NULL.
    *
    ****************************************************************************/
    ...
    *
    *   @return Returns an XMLNode* if a last child exists, else returns NULL.
    *
    ****************************************************************************/
    ...
    *
    *   @return Returns an XMLNode* if nth child exists, else returns NULL.
    *
    ****************************************************************************/
    
    XMLNode* getNthChild(unsigned int n) const;
...
/*************************************************************************//*!
*
*   @brief The XMLParsley class parses and manages XML documents and nodes.
*
****************************************************************************/
